...
`goto` statements and labels should not be used to jump between blocks, as it can easily lead to unstructured code. `goto` should not be used either to jump between `case`s of a `switch`.
